...
[Wed May 20 13:43:37 2015]
-------------------------

The generator produced the following files:

The Box class:
- ovpCBoxAlgorithmLabelTarget.h
- ovpCBoxAlgorithmLabelTarget.cpp
...
You may have to change the file ovpCBoxAlgorithmLabelTarget.h to make it find the included file ovp_defines.h, whose path is related to the project used.
...
#include "[my-box-folder]/ovpCBoxAlgorithmLabelTarget.h"
